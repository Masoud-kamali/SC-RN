    ...
    <View style={styles.container}>
      <View style={styles.head}>
        <View>
          ...
          <FontAwesome name='user' size={40} style={styles.headIcon} />
      </View>
      <View style={styles.body}>
        ...
        <Ripple style={styles.layerBtn} onPress={()=> navigation.navigate('ActivityDrawerNavigator')}>
          ...
          <MaterialCommunityIcons name='text-box-plus' style={styles.activityIcon}/>
        </Ripple>
        <Ripple style={styles.layerBtn} onPress={()=> navigation.navigate('PlanDrawerNavigator')}>
          ...
          <MaterialCommunityIcons name='text-box-check-outline' style={styles.activityIcon}/>
        </Ripple>
        <Ripple style={styles.layerBtn} onPress={()=> navigation.navigate('InboxDrawerNavigator')}>
          ...
          <MaterialCommunityIcons name='text-box-search' style={styles.activityIcon}/>
        </Ripple>
        <Ripple style={styles.layerBtn} onPress={()=> navigation.navigate('InboxDrawerNavigator')}>
          <Text
            style={styles.layerText}
          ...
          <MaterialCommunityIcons name='email' style={styles.activityIcon}/>
        </Ripple>
