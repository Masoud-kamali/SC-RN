...
const Content = (props) =>{
    ...
    const [userIconHandler, setUserIconHandler] = useState(24);
    const [passIconHandler, setPassIconHandler] = useState(24);
    ...
    const _changeBorderUser = () =>{
        ...
        setFocusPassHandler(false);
        setUserIconHandler(28);
        setPassIconHandler(24);
    };

    const _changeBorderPass = () =>{
        setFocusPassHandler(true);
        setFocusUserHandler(false);
        setUserIconHandler(24);
        setPassIconHandler(28);
    };
    ...
    const _removeBorderPass = async (item) =>{
        ...
        if(item == 1 ) {
            ...
            await alert('این صفحه هنوز ایجاد نشده است')

        }else if (item == 2) {
            await navigation.navigate('UserType')
        }
    };
        ...
        <View style={styles.container}>
            ...
            <View style={styles.secOne}>
                ...
                >
                    ...
                    />
                    <Icon name="user" size={userIconHandler} color="#090962" />
                </TouchableOpacity>
                <TouchableOpacity
                ...
                >
                    ...
                    />
                    <Icon name="lock" size={passIconHandler} color="#090962" />
                </TouchableOpacity>
